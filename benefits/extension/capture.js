...
(function (root) {
  ...
  if (typeof module !== 'undefined' && module.exports) module.exports = api;
    ...
    root.BenefitCapture = api;
    // כבוקמרקלט הקוד רץ מיד. כשהוא נטען מתוך תוסף הדפדפן, התוסף מציב
    // דגל לפני הטעינה, והסריקה מופעלת רק לפי בקשה מהחלונית.
    if (root.document && !root.__BENEFIT_CAPTURE_NO_AUTORUN) run();
  }
